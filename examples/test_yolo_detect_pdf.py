...
This is an example/debug utility (not used by the web app).
"""
...
def print_detection_summary(detections: dict, page_num: int):
    ...
    if len(boxes) > 0:
        ...
        for idx in sorted_indices:
            ...
            print(
                f"  {class_names[idx]}: score={scores[idx]:.3f}, bbox=({x1:.0f},{y1:.0f},{x2:.0f},{y2:.0f})"
            )
...
def main():
    ...
    parser.add_argument("--pages", type=str, default=None, help='Page range (e.g., "1-3" or "1,3,5") or "all"')
