  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-20 bg-white border-b z-50 px-6 flex items-center justify-between">
      ...
      <nav className="hidden md:flex items-center gap-6">
        <Link href="/" className="text-sm font-medium hover:text-[#0060ac]">
          Trang chủ
        </Link>
        <Link href="/chatbot" className="bg-[#0060ac] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#004d8a] transition-colors">
          Hỗ trợ giải đáp thắc mắc văn bản hành chính
        </Link>
      </nav>
    </header>
  )
